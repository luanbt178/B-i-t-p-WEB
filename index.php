...
<head>
    ...
    <link href=".\icon\themify-icons\themify-icons.css" rel="stylesheet">
        ...
        <main>
            <section class="nike_row">
                <table>
                    ...
                    <tr>
                        <td class="img_row_1"><img src="img\NIKE+BLAZER+MID+'77+(GS).png" alt=""></td>
                        <td class="img_row_1"><img src="img\NIKE+AIR+MAX+90+LTR+(GS).png" alt=""></td>
                        <td class="img_row_1"><img src="img\NIKE+AIR+MAX+SC.png" alt=""></td>
                    </tr>
                    <tr>
                    ...
                    <div class="carousel-container">
                        <div class="carousel-item">
                            <div class="img_container">
                                <img src="img/BitisIcon.jfif" alt="" onclick="infor_Prod()">
                        ...
                        <div class="carousel-item">
                            <div class="img_container">
                                <img src="img/IconAdidas.jfif" alt="">
                        ...
                        <div class="carousel-item">
                            <div class="img_container">
                                <img src="img/IconNike2.jfif" alt="">
